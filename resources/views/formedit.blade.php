...
<html lang="en-US" dir="ltr">
  ...
  <head>
    ...
    <link href="../../assets/css/phoenix.min.css" rel="stylesheet">
                  ...
                  <div class="card-header mb-3 bg-soft">
                    ...
                    @endif
                        ...
                        <div class="table-responsive scrollbar">
                          ...
                          <table id="ftable" class="table table-bordered table-striped fs--1 mb-0">
                            ...
                            <?php $count = 0; ?>
                              @foreach($data as $d)
                              <tr>
                                <input type="hidden" name="fishid[]" value="{{$d->id}}">
                                <td><input type="text" name="fish[]" value="{{old('fish.0',$d->fish)}}" class="form-control width"></td>
                                <td><input type="text" name="uom[]" value="{{old('uom.0',$d->uom)}}" class="form-control"></td>
                                <td><input type="text" name="weight[]" value="{{old('weight.0',$d->kg)}}" class="form-control"></td>
                                <td><input type="number" step="0.1" min="0" name="size1d[]" id="size1d[{{$count}}]" onchange="autoweight(this.id,this.value)" value="{{old('size1d.0',$d->size1d)}}" class="form-control"></td>
                                <td><input type="number" step="0.1" min="0" name="size1015[]" id="size1015[{{$count}}]" onchange="autoweight(this.id,this.value)" value="{{old('size1015.0',$d->size1015)}}" class="form-control"></td>
                                <td><input type="number" step="0.1" min="0" name="size12[]" id="size12[{{$count}}]" onchange="autoweight(this.id,this.value)" value="{{old('size12.0',$d->size12)}}" class="form-control"></td>
                                <td><input type="number" step="0.1" min="0" name="size23[]" id="size23[{{$count}}]" onchange="autoweight(this.id,this.value)" value="{{old('size23.0',$d->size23)}}" class="form-control"></td>
                                <td><input type="number" step="0.1" min="0" name="size34[]" id="size34[{{$count}}]" onchange="autoweight(this.id,this.value)" value="{{old('size34.0',$d->size34)}}" class="form-control"></td>
                                <td><input type="number" step="0.1" min="0" name="size35[]" id="size35[{{$count}}]" onchange="autoweight(this.id,this.value)" value="{{old('size35.0',$d->size35)}}" class="form-control"></td>
                                <td><input type="number" step="0.1" min="0" name="size45[]" id="size45[{{$count}}]" onchange="autoweight(this.id,this.value)" value="{{old('size45.0',$d->size45)}}" class="form-control"></td>
                                <td><input type="number" step="0.1" min="0" name="size46[]" id="size46[{{$count}}]" onchange="autoweight(this.id,this.value)" value="{{old('size46.0',$d->size46)}}" class="form-control"></td>
                                <td><input type="number" step="0.1" min="0" name="size56[]" id="size56[{{$count}}]" onchange="autoweight(this.id,this.value)" value="{{old('size56.0',$d->size56)}}" class="form-control"></td>
                                <td><input type="number" step="0.1" min="0" name="size58[]" id="size58[{{$count}}]" onchange="autoweight(this.id,this.value)" value="{{old('size58.0',$d->size58)}}" class="form-control"></td>
                                <td><input type="number" step="0.1" min="0" name="size68[]" id="size68[{{$count}}]" onchange="autoweight(this.id,this.value)" value="{{old('size68.0',$d->size68)}}" class="form-control"></td>
                                <td><input type="number" step="0.1" min="0" name="size810[]" id="size810[{{$count}}]" onchange="autoweight(this.id,this.value)" value="{{old('size810.0',$d->size810)}}" class="form-control"></td>
                                <td><input type="number" step="0.1" min="0" name="size1012[]" id="size1012[{{$count}}]" onchange="autoweight(this.id,this.value)" value="{{old('size1012.0',$d->size1012)}}" class="form-control"></td>
                                <td><input type="number" step="0.1" min="0" name="size1215[]" id="size1215[{{$count}}]" onchange="autoweight(this.id,this.value)" value="{{old('size1215.0',$d->size1215)}}" class="form-control"></td>
                                <td><input type="number" step="0.1" min="0" name="size15up[]" id="size15up[{{$count}}]" onchange="autoweight(this.id,this.value)" value="{{old('size15up.0',$d->size15up)}}" class="form-control"></td>
                                <td><input type="number" step="0.1" min="0" name="tcarton[]" value="{{old('tcarton.0',$d->tcarton)}}" class="form-control width2"></td>
                                <td><input type="number" step="0.1" min="0" name="tkg[]" id="tkg[{{$count}}]" value="{{old('tkg.0',$d->tkg)}}" class="form-control width2"></td>
                              </tr>
                              <?php $count++;
                                  $status=$d->status;
                               ?>
                      ...
                      <div class="mb-3 text-center">
                        <button class="btn btn-secondary me-1 mb-1" type="submit">ပြင်ဆင်မည်</button>
                        <a href="/<?php echo $status; ?>" class="btn btn-secondary me-1 mb-1">နောက်သို့</a>
                      </div>
                  </div>
                </div>
                </form>
