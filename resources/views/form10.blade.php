              ...
              <form method="post" action="{{route('form10save')}}">
                        ...
                        <div class="table-responsive scrollbar">
                          ...
                          <table id="ftable" class="table table-bordered table-striped fs--1 mb-0">
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="weight[]" value="{{old('weight.0')}}" id="weight[0]" onchange="autoweight(this.id,this.value)" class="form-control"></td>
                              ...
                              <tr>
                                ...
                                <td><input type="text" name="weight[]" value="{{old('weight.1')}}" id="weight[1]" onchange="autoweight(this.id,this.value)" class="form-control"></td>
                              ...
                              <tr>
                                ...
                                <td><input type="text" name="weight[]" value="{{old('weight.2')}}" id="weight[2]" onchange="autoweight(this.id,this.value)" class="form-control"></td>
                          ...
                          <input type="hidden" name="status" value="form10">
                        </div>
                ...
                <div class="card shadow-none border border-300 p-4" data-component-card="">
                  <div class="card-header mb-3 bg-soft">
                    <div class="row g-3 justify-content-between align-items-center">
                      <div class="col-12 col-md">
                        <h4 class="mb-2">Choose Form 10 List</h4>
                          ...
                          <table id="ftable" class="table table-bordered text-center table-striped fs--1 mb-0">
                            <thead class="bg-200 text-900">
                              ...
                              <tr>
                                ...
                                <th data-sort="size">Form 10 List by DateTime</th>
                                <th>By User</th>
